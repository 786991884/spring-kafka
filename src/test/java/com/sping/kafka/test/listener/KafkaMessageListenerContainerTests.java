package com.sping.kafka.test.listener;
...
public class KafkaMessageListenerContainerTests {
    ...
    @ClassRule
    public static KafkaEmbedded embeddedKafka = new KafkaEmbedded(1, true, topic1, topic2, topic3, topic4, topic5, topic6, topic7);
